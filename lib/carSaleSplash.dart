          ...
          child: Column(
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  title: Text(
                    "Envianos fotos e información básica de tu vehículo.",
                    style: TextStyle(
                      fontSize: 19.0,
                      fontWeight: FontWeight.bold,
                    ),
                ...
                ListTile(
                  ...
                  title: Text(
                    "Evaluamos tu solicitud en menos de 24 horas.",
                    style: TextStyle(
                      fontSize: 19.0,
                      fontWeight: FontWeight.bold,
                    ),
                ...
                ListTile(
                  ...
                  title: Text(
                    "Realizamos el pago inmediatamente tu solicitud haya sido aprobada.",
                    style: TextStyle(
                      fontSize: 19.0,
                      fontWeight: FontWeight.bold,
                    ),
